  ...
  @if ($records>0 || $updaterecords>0)
   ...
   @endif
     <div class="row">
          <div class="col-xs-6">
            <div class="title">
              <h3>Proceso Cálculo de Comisiones</h3>
            </div>
            <div class="card card-nav">
            <div class="content">
              <div class="form-group col-md-2">
             <a href="{{URL::action('ComisionController@execCalcCom')}}" > <button type="button" class="btn btn-primary">EJECUTAR PROCESO <i class="material-icons">sync</i></button></a>
           </div>
            </div>
            </div>
            </div>
        </div>
        {!!Form::open(array('url'=>'agenda/dataexcel/downloadCom','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}

        <div class="row">
             <div class="col-xs-6">
               <div class="title">
                 <h3>Descargar Cálculo de Comisiones</h3>
               </div>
               <div class="card card-nav">
               <div class="content">
                 <div class="row">
                 ...
                 <div class="form-group col-md-2">
                <button type="submit" class="btn btn-primary">DESCARGAR  <i class="material-icons">file_download</i></button></a>
              </div>
               </div>
               </div>
               </div>
