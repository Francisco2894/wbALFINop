{!!Form::open(array('url'=>'agenda/vencimiento/','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
   ...
   <a href="{{URL::action('PdfController@getPdfVenc',['searchTxt'=> $searchTxt])}}" > <button type="button" class="btn btn-primary">PDF <i class="material-icons">file_download</i></button></a>
 </div>
{{Form::close()}}
