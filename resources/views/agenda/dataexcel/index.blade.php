     ...
     <div class="row">
         ...
         <form class="form-horizontal" method="POST" action="{{action('ExcelController@importFliq')}}" enctype="multipart/form-data">
           ...
           <div class="row">
                <div class="col-xs-6">
                  <div class="title">
                    <h3>Importar Fecha Liquidacion</h3>
                  </div>
                  <div class="card card-nav">
                  <div class="content">
            ...
            <form class="form-horizontal" method="POST" action="{{action('ExcelController@importFeje')}}" enctype="multipart/form-data">
               {{ csrf_field() }}
              <div class="row">
                   <div class="col-xs-6">
                     <div class="title">
                       <h3>Importar Fecha Ejercido</h3>
                     </div>
                     <div class="card card-nav">
                     <div class="content">
                       <label for="rptrce">Reporte créditos Ejercidos</label>
                     <input class="btn btn-simple" type="file" name="rptrce" accept=".csv" value="">
                      <button class="btn btn-primary btn-sm" type="submit"><i class="material-icons">save</i>  GUARDAR EN BD</button>
